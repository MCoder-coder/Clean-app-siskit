...
class MapDriveModeUseCase @Inject constructor(private val mapDriveModeRepository: MapDriveModeRepository){
    fun  invoke(context: Context, mapView: MapView , myLocationOverlay: MyLocationOverlay)  {
          return mapDriveModeRepository.mapDriveMode(context , mapView , myLocationOverlay)
    }
}